...
The limitations we encountered using these tools rooted in our past work experience with collaborative productivity tools led to our firm belief that there is, and will be, a glass ceiling on what's possible in the future for tools like Notion. This emanates from these tools probable struggles to scale horizontally at some point. They will likely be forced to prioritize a proportion of customers whose needs differ from the rest. While decision-makers want a workplace OS, the truth is that it is impossible to come up with a one-size fits all solution in such a fragmented market.
