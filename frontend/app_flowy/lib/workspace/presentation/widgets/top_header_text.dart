...
class ViewHeaderText extends StatefulWidget {
  final ViewPB view;

  ViewHeaderText({required this.view, Key? key})
      : super(key: ValueKey(view.hashCode));

  @override
  State<ViewHeaderText> createState() => _ViewHeaderTextState();
}

class _ViewHeaderTextState extends State<ViewHeaderText> {
