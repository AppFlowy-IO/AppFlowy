...
class SignInPayloadPB extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignInPayloadPB', createEmptyInstance: create)
  ...
  SignInPayloadPB._() : super();
  factory SignInPayloadPB({
    $core.String? email,
  ...
  factory SignInPayloadPB.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SignInPayloadPB.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SignInPayloadPB clone() => SignInPayloadPB()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SignInPayloadPB copyWith(void Function(SignInPayloadPB) updates) => super.copyWith((message) => updates(message as SignInPayloadPB)) as SignInPayloadPB; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SignInPayloadPB create() => SignInPayloadPB._();
  SignInPayloadPB createEmptyInstance() => create();
  static $pb.PbList<SignInPayloadPB> createRepeated() => $pb.PbList<SignInPayloadPB>();
  @$core.pragma('dart2js:noInline')
  static SignInPayloadPB getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SignInPayloadPB>(create);
  static SignInPayloadPB? _defaultInstance;
...
class SignUpPayloadPB extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SignUpPayloadPB', createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'email')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  SignUpPayloadPB._() : super();
  factory SignUpPayloadPB({
    $core.String? email,
    $core.String? name,
    $core.String? password,
  }) {
  ...
  factory SignUpPayloadPB.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SignUpPayloadPB.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  SignUpPayloadPB clone() => SignUpPayloadPB()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SignUpPayloadPB copyWith(void Function(SignUpPayloadPB) updates) => super.copyWith((message) => updates(message as SignUpPayloadPB)) as SignUpPayloadPB; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SignUpPayloadPB create() => SignUpPayloadPB._();
  SignUpPayloadPB createEmptyInstance() => create();
  static $pb.PbList<SignUpPayloadPB> createRepeated() => $pb.PbList<SignUpPayloadPB>();
  @$core.pragma('dart2js:noInline')
  static SignUpPayloadPB getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SignUpPayloadPB>(create);
  static SignUpPayloadPB? _defaultInstance;
