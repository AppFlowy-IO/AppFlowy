  ...
  Color getColorOfDot(SelectOptionColorPB color) {
    return switch (Theme.of(context).brightness) {
      Brightness.light => switch (color) {
          SelectOptionColorPB.Purple => const Color(0xFF9E7DFF),
          SelectOptionColorPB.Pink => const Color(0xFFFF8EF5),
          SelectOptionColorPB.LightPink => const Color(0xFFFFB0C6),
          SelectOptionColorPB.Orange => const Color(0xFFFFBE8C),
          SelectOptionColorPB.Yellow => const Color(0xFFFFDC80),
          SelectOptionColorPB.Lime => const Color(0xFFC8FF37),
          SelectOptionColorPB.Green => const Color(0xFF66CF80),
          SelectOptionColorPB.Aqua => const Color(0xFF5AFFBA),
          SelectOptionColorPB.Blue => const Color(0xFF00C8FF),
          _ => throw ArgumentError,
        },
      Brightness.dark => switch (color) {
          SelectOptionColorPB.Purple => const Color(0xFFAA55FF),
          SelectOptionColorPB.Pink => const Color(0xFFFF48AA),
          SelectOptionColorPB.LightPink => const Color(0xFFFF40EB),
          SelectOptionColorPB.Orange => const Color(0xFFC8680E),
          SelectOptionColorPB.Yellow => const Color(0xFFA8A314),
          SelectOptionColorPB.Lime => const Color(0xFF78C814),
          SelectOptionColorPB.Green => const Color(0xFF14BA38),
          SelectOptionColorPB.Aqua => const Color(0xFF11878C),
          SelectOptionColorPB.Blue => const Color(0xFF1836CA),
          _ => throw ArgumentError,
        }
    };
  }
