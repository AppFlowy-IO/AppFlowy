...
class _FilterButtonState extends State<FilterButton> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<FilterMenuBloc, FilterMenuState>(
      builder: (context, state) {
        ...
        return _wrapPopover(
          ...
          FlowyTextButton(
            ...
            onPressed: () {
              final bloc = context.read<FilterMenuBloc>();
              if (bloc.state.filters.isEmpty) {
                _popoverController.show();
              } else {
                bloc.add(const FilterMenuEvent.toggleMenu());
              }
            },
          ),
        );
  ...
  Widget _wrapPopover(BuildContext buildContext, Widget child) {
    return AppFlowyPopover(
      ...
      popupBuilder: (BuildContext context) {
        final bloc = buildContext.read<FilterMenuBloc>();
