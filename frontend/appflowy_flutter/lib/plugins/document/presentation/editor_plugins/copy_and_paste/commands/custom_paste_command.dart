...
import 'package:appflowy/plugins/document/presentation/editor_plugins/copy_and_paste/editor_state_extensions/editor_state_extensions.dart';
...
CommandShortcutEventHandler _pasteCommandHandler = (editorState) {
  ...
  // because the event handler is not async, so we need to wrap it with an async function here
  () async {
