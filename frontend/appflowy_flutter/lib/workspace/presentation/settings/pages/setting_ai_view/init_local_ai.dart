...
import 'package:appflowy/workspace/application/settings/ai/init_local_ai_bloc.dart';
...
class InitLocalAIIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          InitLocalAIBloc()..add(const InitLocalAIEvent.started()),
      child: DecoratedBox(
        ...
        child: Padding(
          ...
          child: BlocBuilder<LocalAIConfigBloc, LocalAIConfigState>(
