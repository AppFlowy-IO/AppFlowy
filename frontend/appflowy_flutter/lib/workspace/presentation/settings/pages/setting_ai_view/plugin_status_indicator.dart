...
void onDownloadButtonPressed() {
  AIEventGetLocalAIDownloadLink().send().fold(
        (app) => afLaunchUri(Uri.parse(app.link)),
        (err) {},
      );
}
