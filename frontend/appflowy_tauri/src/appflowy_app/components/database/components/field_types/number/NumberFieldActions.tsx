...
import { NumberField, updateTypeOption } from '$app/components/database/application';
  ...
  return (
    <>
      <div className={'flex flex-col pr-3 pt-1'}>
        ...
        <NumberFormatSelect value={field.typeOption.format || NumberFormatPB.Num} onChange={onChange} />
      </div>
