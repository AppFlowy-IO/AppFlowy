  ...
  return (
    <BlockPortal blockId={id}>
      <div
        ...
        className='absolute mt-[-6px] inline-flex h-[32px] min-w-[100px] items-stretch overflow-hidden rounded-[8px] bg-fill-toolbar leading-tight text-content-onfill shadow-md transition-opacity duration-100'
        onMouseDown={(e) => {
