...
export const SelectionToolbar = memo(() => {
  ...
  return (
    <div
      ref={ref}
      className={
        'selection-toolbar pointer-events-none absolute z-[100] flex min-h-[37px] w-fit flex-grow transform items-center rounded-lg bg-[var(--fill-toolbar)] p-2 opacity-0 shadow-lg transition-opacity'
      }
      onMouseDown={(e) => {
