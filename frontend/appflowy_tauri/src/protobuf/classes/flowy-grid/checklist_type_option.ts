...
export class ChecklistTypeOptionPB extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static fromObject(data: {
        ...
        const message = new ChecklistTypeOptionPB({});
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ChecklistTypeOptionPB {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ChecklistTypeOptionPB();
    ...
    static deserializeBinary(bytes: Uint8Array): ChecklistTypeOptionPB {
        return ChecklistTypeOptionPB.deserialize(bytes);
    }
}
