...
export class SingleSelectTypeOptionPB extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static fromObject(data: {
        ...
        const message = new SingleSelectTypeOptionPB({});
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SingleSelectTypeOptionPB {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new SingleSelectTypeOptionPB();
    ...
    static deserializeBinary(bytes: Uint8Array): SingleSelectTypeOptionPB {
        return SingleSelectTypeOptionPB.deserialize(bytes);
    }
}
