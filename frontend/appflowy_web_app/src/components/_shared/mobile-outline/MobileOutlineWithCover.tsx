...
function MobileOutlineWithCover ({ view, navigateToView, timePrefix }: {
  view: View;
    ...
    <>
      ...
      >
        <div className={'flex flex-col flex-1 gap-4'}>
          ...
          {view.last_edited_time && <div className={'text-text-caption text-xs'}>
            {timePrefix || ''}
            {getRelativeTime(view.last_edited_time)}
          </div>}
