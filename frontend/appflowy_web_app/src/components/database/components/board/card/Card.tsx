...
export const Card = memo(({ groupFieldId, rowId, onResize, isDragging }: CardProps) => {
  ...
  return (
    <div
      ...
      className='relative flex cursor-pointer flex-col gap-2 rounded-lg border border-line-border p-3 text-xs shadow-sm hover:bg-fill-list-active hover:shadow'
    >
