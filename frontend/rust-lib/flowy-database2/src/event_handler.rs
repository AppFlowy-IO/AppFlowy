...
fn upgrade_manager(
  database_manager: AFPluginState<Weak<DatabaseManager2>>,
) -> FlowyResult<Arc<DatabaseManager2>> {
...
pub(crate) async fn get_database_data_handler(
  ...
  manager: AFPluginState<Weak<DatabaseManager2>>,
...
pub(crate) async fn create_database_view(
  ...
  _manager: AFPluginState<Weak<DatabaseManager2>>,
) -> FlowyResult<()> {
