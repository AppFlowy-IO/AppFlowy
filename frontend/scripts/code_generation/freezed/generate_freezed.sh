...
flutter clean > /dev/null 2>&1 && flutter packages pub get > /dev/null 2>&1 && flutter pub run build_runner clean && flutter pub run build_runner build --delete-conflicting-outputs
